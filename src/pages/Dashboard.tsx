...
import { BarChart3, Users, Eye, Heart, Settings, FileText, Video, Calendar, MessageSquare, UserPlus } from 'lucide-react';
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <Button variant="outline" className="h-20 flex flex-col" onClick={() => setActiveTab('team')}>
            ...
            <TabsContent value="posts">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Crie e gerencie as publicações da sua instituição</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="applications">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Gerencie as candidaturas aos cursos da sua instituição</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">Funcionalidade de candidaturas em desenvolvimento...</p>
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
